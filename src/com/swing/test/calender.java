...
public class calender extends JPanel{
    ...
    private calender(java.util.Date date, String format, int startDAY){
    ...
    public static calender getInstance(java.util.Date date, String format){
        return new calender(date, format, defaultStartDAY);
    }

    public static calender getInstance(java.util.Date date){
        return getInstance(date, DEFAULTFORMAT);
    }
    public static calender getInstance(String format){
    ...
    private class LabelManager {
        ...
        public LabelManager(){
            list = new ArrayList<calender.DayLabel>();
        }
