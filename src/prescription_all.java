...
public class prescription_all extends HFrame{
	//JPanel panel;
	...
	prescription_all()
	{
        ...
        title = new JLabel("Prescription All");
        ...
        close.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            	dispose();
            	prescription_details rd = new prescription_details("PSID_1");
        		rd.setVisible(true);
        ...
        String[] search1 = {"prescription id","Medi/Serv id","frequency","number of days","Status"};
	...
	public void showall()
	{
		...
		String selectsql;
		if(seartext.equals(""))
			selectsql = "select * from prescription_details";
		else{
			String type="";
			if(t == "prescription id")
				type = "prescription_id";
			if(t == "Medi/Serv id")
				type = "medicine_service_id";
			if(t == "frequency")
				type = "frequency";
			if(t == "number of days")
				type = "no_of_days";
			if(t == "Status")
				type = "status";
			selectsql = "select * from prescription_details where "+type+" like '"+seartext+"'";
		}
		System.out.println(selectsql);
		String[] columnName = {"prescription id","Medi/Serv id","frequency","number of days","Status"};
		Object[][] data1 = null;
		try {
