...
public class Details extends HFrame{
	private static final long serialVersionUID = 1L;
	JPanel mainPanel;
	JTable Table;
	JLabel titleLabel, DetailsLabel, visitIdJLabel, visitDateJLabel, middleJLabel, visitTimeJLabel, doctorIdJLabel, patientIdJLabel, admissionIdJLabel, descriptionJLabel, recordJLabel, statusJLabel;
	JTextField visitIdJTextField, visitTimeJTextField, descripitionJTextField, statusJTextField;
	...
	JButton doctorIdButton, patientIdButton, admissionIdButton;
	JComboBox<String> visitDateBox, doctorIdBox, patientIdBox, admissionIdBox;
	...
	public Details()
	{
        ...
        visitDateBox = new JComboBox<String>();
        visitDateBox.setBounds(270, 160, 200, 20);
        mainPanel.add(visitDateBox);
        ...
        doctorIdBox = new JComboBox<String>();
        doctorIdBox.setBounds(270, 220, 200, 20);
        mainPanel.add(doctorIdBox);
        
        doctorIdButton = new JButton("...");
        doctorIdButton.setBounds(490, 220, 100, 20);
        mainPanel.add(doctorIdButton);
        
        patientIdJLabel = new JLabel("Patient ID : ");
        patientIdJLabel.setBounds(100, 250, 150, 20);
        mainPanel.add(patientIdJLabel);
        
        patientIdBox = new JComboBox<String>();
        patientIdBox.setBounds(270, 250, 200, 20);
        mainPanel.add(patientIdBox);
        
        patientIdButton = new JButton("...");
        patientIdButton.setBounds(490, 250, 100, 20);
        mainPanel.add(patientIdButton);
        
        admissionIdJLabel = new JLabel("Admission ID : ");
        admissionIdJLabel.setBounds(100, 280, 150, 20);
        mainPanel.add(admissionIdJLabel);
        
        admissionIdBox= new JComboBox<String>();
        admissionIdBox.setBounds(270, 280, 200, 20);
        mainPanel.add(admissionIdBox);
        
        admissionIdButton = new JButton("...");
        admissionIdButton.setBounds(490, 280, 100, 20);
        mainPanel.add(admissionIdButton);
        ...
        statusJLabel.setBounds(100, 340, 150, 20);
        mainPanel.add(statusJLabel);
        
        statusJTextField = new JTextField();
        statusJTextField.setBounds(270, 340, 200, 20);
        mainPanel.add(statusJTextField);
        
                
        middleJLabel = new JLabel("----------------------------------------------------------------------------------------");
        middleJLabel.setFont(new Font("Courier",1,15));
        middleJLabel.setBounds(80, 370, 500, 20);
        mainPanel.add(middleJLabel); 
        
        JScrollPane scrollPane=new JScrollPane();
		scrollPane.setBounds(50, 400, 800, 100);
