...
public class ViewAllOutService extends HFrame{
	/**
	 * 
	 */
	...
	ViewAllOutService()
	{
        ...
        title = new JLabel("All Out Patient Service Appointment Bill Payments");
        ...
        close.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            	dispose();
            	service_appointment_bill_payments rd = new service_appointment_bill_payments("SPID_1");
        		rd.setVisible(true);
...
public void showall()
	{
		...
		if(seartext.equals(""))
			...
			if(t == "Bank")
				type = "bank";
			selectsql = "select * from service_appointment_bill_payment where "+type+" like '"+seartext+"'";
		}
