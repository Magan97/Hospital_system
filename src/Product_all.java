...
public class Product_all extends HFrame{
	//JPanel panel;
       ...
       // panel = new JPanel();
        ...
        close.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            	dispose();
            	Medicine_product_details rd = new Medicine_product_details("PDID_1");
        		rd.setVisible(true);
        ...
        String[] search1 = {"Product id","Product name","Category id","Supplier id","units in stock","unit price","recorder level","status"};
	...
	public void showall()
	{
		...
		String selectsql;
		if(seartext.equals(""))
			selectsql = "select * from medicine_details";
		else{
			String type="";
			if(t == "Product id")
				type = "product_id";
			...
			if(t == "status")
				type = "status";
			selectsql = "select * from medicine_details where "+type+" like '"+seartext+"'";
		}
		System.out.println(selectsql);
		String[] columnName = {"Product id","Product name","Category id","Supplier id","units in stock","unit price","recorder level","status"};
		Object[][] data1 = null;
		try {
			...
			try{
				...
				while(rs2.next()){
					...
					data1[i][2] = rs2.getString("category_id");
					data1[i][3] = rs2.getString("supplier_id");
					data1[i][4] = rs2.getString("units_in_stock");
					data1[i][5] = rs2.getString("unit_price");			
					data1[i][6] = rs2.getString("recorder_level");
