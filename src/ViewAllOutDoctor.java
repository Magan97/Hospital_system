...
public class ViewAllOutDoctor extends HFrame{
	//JPanel panel;
	...
	ViewAllOutDoctor()
	{
        ...
        title = new JLabel("All Out Patient Doctor Appointment Bill Payments");
        ...
        close.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            	dispose();
            	OutPatientDoctorAppointment p = new OutPatientDoctorAppointment("DPID_1");
                p.setVisible(true);
        ...
        String[] search1 = {"SL NO","Amount Paid","Paid Date","Pay Type","DD/CHEQUE NO","DD Date","Bank"};
...
public void showall()
	{
		...
		if(seartext.equals(""))
			...
			if(t == "Bank")
				type = "bank";
			selectsql = "select * from appointment_bill_payment where "+type+" like '"+seartext+"'";
		}
		System.out.println(selectsql);
		String[] columnName = {"SL NO","Amount Paid","Paid Date","Pay Type","DD/CHEQUE NO","DD Date","Bank"};
		Object[][] data1 = null;
		try {
